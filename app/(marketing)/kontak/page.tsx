...
export default async function KontakPage() {
  ...
  return (
    <>
      ...
      {/* NOTE: Traditional FAQ accordion section retired — replaced by the
          guided Customer Support panel triggered from the header "Bantuan"
          button. Settings.faq is now consumed exclusively by that panel. */}
    </>
  );
}
